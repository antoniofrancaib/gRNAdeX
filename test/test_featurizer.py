...
if __name__ == "__main__":
    ...
    # TODO: Be aware of what split you are using !
    ...
    # HERE I WON'T USE NULLOMERS
    parser.add_argument('--use_nullomers', dest='use_nullomers', default=False, type=bool,
    ...
    if args.run_type.lower() == 'multi':
        ...
        gRNAde_module = gRNAde(split=args.split, max_num_conformers=3, gpu_id=0)
        ...
        print('Model from split is ready !')
        # TODO: for some reason 3jtp does NOT work
        ...
        sequences, samples, perplexity, recovery_sample, sc_score = gRNAde_module.design_from_pdb_file(
            pdb_filepath = os.path.join(PROJECT_PATH, "data/raw/"+args.filename+".pdb"),
            output_filepath = os.path.join(PROJECT_PATH, "test/featurizer/"+args.filename+".fasta"),
            n_samples = 16,
            temperature = 1.0,
            seed = 0,
            avoid_sequences = args.avoid_sequences,
